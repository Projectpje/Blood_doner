...
export default class Questionnaire extends Component {
    ...
    validate = () => {
        ...
        firebase.database().ref(`donorInfo/${userId}`).update({
            smoke,
            drink,
            diseases,
            lastBloodDonation,
            ...
            alert("Some error occured while saving data. Please try again" + error.message);
        }).finally(() => {
    ...
    render() {
        ...
        const { loading,
            ...
            lastAbroadVisit,
            showBloodDatePicker,
            showLastVisitDatePicker } = this.state;

        return (
            <KeyboardAwareScrollView style={Styles.containerStyle}>
                <AppText>Few Questions</AppText>

                <AppText style={Styles.labelStyle} isMandatory>Do you smoke?</AppText>
                ...
                <AppText style={Styles.labelStyle} isMandatory>Do you drink?</AppText>
                <View
                    style={{ zIndex: 9 }}
                >
                    <DropDownPickerWrapper
                ...
                <AppText style={Styles.labelStyle} isMandatory>Do you have any diseases?</AppText>
                <View
                    style={{ zIndex: 8 }}
                >
                    <DropDownPickerWrapper
                ...
                <AppText style={Styles.labelStyle}>When was your blood donation?</AppText>
                <AppTextInput
                ...
                <AppText style={Styles.labelStyle}>When was your last visit to abroad?</AppText>
                <AppTextInput
